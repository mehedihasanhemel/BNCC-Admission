 ...
 * @author mehed
 */
public class WrittenExam extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        RTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Attendence", "Exam ID", "PSID", "Name", "University ID", "Department", "Phone No"
            }
        ) {
        ...
        jLabel1.setText("Select Year and Gender Then press Search .");

        jLabel2.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel2.setText("At the begining of exam Take Attendence and Save.  ");

        jLabel5.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel5.setText("After the judgement of Exam  Seet Written Number can be Update");
        ...
        BackGround.add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 640, 110, 30));
        ...
        BackGround.add(btnSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 640, 110, 30));
        ...
        BackGround.add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 640, 110, 30));
        ...
        BackGround.add(Year, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 640, 110, 30));

        jLabel3.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Year       :");
        BackGround.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 650, 50, -1));
        ...
        BackGround.add(btnClear1, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 640, 110, 30));

        jLabel4.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("Gender  :");
        BackGround.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 650, 50, -1));

        Gender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Male", "Female" }));
        BackGround.add(Gender, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 640, 100, 30));
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        try {
            ...
            if (Gender.getSelectedItem().equals("All")) {
                String sql = "select * from exam where Year = ?";
                pst = con.prepareStatement(sql);
                pst.setInt(1, Integer.parseInt(Year.getText()));

            } else {
                String sql = "select * from exam where Year = ? and Gender = ?";
                pst = con.prepareStatement(sql);
                pst.setInt(1, Integer.parseInt(Year.getText()));
            ...
            tm.setRowCount(0);
            while (rs.next()) {
                //`ExamID`, `PSID`, `Name`, `UID`, `Department`, `Gender`, `PhoneNo`, `Year`, `Attendence`, `Written`
                Object o[] = {rs.getBoolean("Attendence"), rs.getInt("ExamID"), rs.getInt("PSID"), rs.getString("Name"), rs.getString("UID"), rs.getString("Department"), rs.getString("PhoneNo")};
                tm.addRow(o);
            }
    ...
    private void btnClear1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClear1ActionPerformed
        ...
        try {
            ...
            for (int row = 0; row < rows; row++) {
                boolean Atdc = (boolean) RTable.getValueAt(row, 0);
                int ExamID = (Integer) RTable.getValueAt(row, 1);
                int PrimarySelectedID = (Integer) RTable.getValueAt(row, 2);

                String update = "update exam set Attendence = '"+Atdc+"' where PSID ='"+PrimarySelectedID+"'";
// (qty,unitprice,description,total) values ('" + qty + "','" + unitprice + "','" + description + "','" + total + "')";
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WrittenExam.class
